                    ...
                    <li class="px-2 py-1 text-white transition-colors duration-150">
                      <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                        <div class="flex items-center">
                          ...
                          <a href="/admin/comment" class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">comment</a>
                        </div>
                      </div>
                    </li>
                    <li class="px-2 py-1 text-white transition-colors duration-150">
                      <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                        <div class="flex items-center">
                          ...
                          <a href="/admin/invoice" class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Invoices</a>
                        </div>
                      </div>
                    </li>
                  </ul>
